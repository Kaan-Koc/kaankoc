...
export default function Hero() {
    ...
    return (
        <section
            id="hero"
            className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-white via-blue-50 to-yeditepe-100 dark:from-gray-900 dark:via-yeditepe-900 dark:to-gray-900"
        >
            ...
            <div className="absolute inset-0 overflow-hidden">
                <motion.div
                    ...
                    className="absolute top-1/4 left-1/4 w-96 h-96 bg-yeditepe rounded-full blur-3xl"
                />
                <motion.div
                    initial={{ opacity: 0, scale: 0 }}
                    animate={{ opacity: 0.1, scale: 1 }}
            ...
            <motion.div
                ...
                className="absolute bottom-14 md:bottom-8 left-0 right-0 mx-auto w-6"
            >
