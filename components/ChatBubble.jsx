            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        className="mb-4 bg-white dark:bg-gray-800 rounded-2xl shadow-2xl border border-gray-100 dark:border-gray-700 w-[380px] sm:w-[600px] flex flex-col max-h-[calc(100vh-200px)]"
                    >
