            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        className="mb-4 p-6 bg-white dark:bg-gray-800 rounded-2xl shadow-2xl border border-gray-100 dark:border-gray-700 w-[340px] sm:w-[600px] max-h-[calc(100vh-100px)] overflow-hidden flex flex-col"
                    >
