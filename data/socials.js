...
export const socialLinks = [
    ...
    },
    {
        ...
        color: '#000000',
        viewBox: '0 0 24 24',
        icon: <path fill="currentColor" d="M12 2a10 10 0 1 0 10 10A10.011 10.011 0 0 0 12 2Zm0 18a8 8 0 1 1 8-8 8.009 8.009 0 0 1-8 8Zm1-5v-1a4.912 4.912 0 0 1 2.37-4.22.46.46 0 0 0 .23-.39V8.5a.51.51 0 0 0-.58-.5 6.6 6.6 0 0 0-3.02 1.57V6a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v7.22A2.78 2.78 0 1 1 9 10.5a.5.5 0 0 0 .5-.5V9a.5.5 0 0 0-.5-.5 4.28 4.28 0 1 0 4 4.28Z" />
    },
    {
        name: 'YouTube',
        username: '@glusking',
